...
---
## Watches
Days spent Exploring are split into 4 Watches. Your Guide rolls an Omen each Watch and an Omen rolled twice in a journey becomes an Encounter.
## Actions
- **MOVE** to a hex and see all non-hidden features in it. Receiving stress based on the difficulty of the terrain you are entering.
